                    ...
                    @foreach ($ids as $id)
                        <div>
                            <div class="grid grid-cols-1 mt-5">
                                ...
                                <x-tree-select-organ-modal wire:model="images" :id="$id" :image="$images[$id]" />
                                <div class='flex items-center justify-center w-full'>
                                            <img class="h-24 w-24" src="{{ $images[$id]->temporaryUrl() }}"
                                                alt="">
                                        </div>
                ...
                <x-panel>
                    ...
                    <div class="flex overflow-x-scroll space-x-2">
                        @for ($i = 0; $i < count($result['images']); $i++)
                            <img class="w-52 h-52 flex-shrink-0 mx-auto" src="{{ $result['images'][$i]['url']['o'] }}"
                                alt="">
                        @endfor
                    </div>
                        ...
                        <div class="-mt-px flex divide-x divide-gray-200">
                            ...
                            <div class="-ml-px w-0 flex-1 flex">
                                <button type="button"
                                    ...
                                    <svg viewBox="0 0 16 16" class="w-5 h-5 text-green-600" focusable="false" role="img" aria-label="check circle" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                                        <g>
